...
class IQLAAuthor(object):
    ...
    def __unicode__(self):
        ...
        :return:
        """
        return u"IQLAAuthor(name:{}, n_texts:{})".format(self._name, len(self._texts))
    # end __unicode__
    ...
    def __str__(self):
        ...
        :return:
        """
        return "IQLAAuthor(name:{}, n_texts:{})".format(self._name, len(self._texts))
    # end __unicode__
    ...
    def _load(self):
        ...
        for author_text in author_texts:
            self._texts.append(IQLAText(text_path=os.path.join(self._dataset_path, author_text + ".txt"), author=self))
        # end for
    # end _load
